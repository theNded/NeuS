...
class Runner:
    def __init__(
        self, conf_path, args, mode="train", case="CASE_NAME", is_continue=False
    ):
        ...
        self.conf[
            "dataset.data_dir"
        ] = args.data_dir  # self.conf['dataset.data_dir'].replace('CASE_NAME', case)
...
if __name__ == "__main__":
    ...
    runner = Runner(args.conf, args, args.mode, args.case, args.is_continue)
